...
return {
  ...
  analogNeedleLength = 188,
  analogNeedleWidth = 7,
  analogNeedleGlowWidth = 19,
  analogNeedleHaloWidth = 12,
  analogNeedleBacklightTipRadius = 10,
  analogNeedleBacklightArcSpan = math.rad(18),
  ...
  analogElectronicsX = 202,
  analogElectronicsFirstY = 280,
  analogElectronicsSpacingY = 49,
  analogElectronicsSpacingX = 48,
  analogStatusPodRadius = 21,
  analogAuxLabelY = 464,
  ...
  analogFlagX = 449,
  analogFlagY = 259,
  analogFlagPodHalfSize = 26,
  analogFlagPodChamfer = 6,
  analogFlagGlowSpread = 8,
